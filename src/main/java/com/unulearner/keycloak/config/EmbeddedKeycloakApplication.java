package com.unulearner.keycloak.config;
...
import com.unulearner.keycloak.config.KeycloakServerProperties.AdminUser;
...
public class EmbeddedKeycloakApplication extends KeycloakApplication {
	...
	protected ExportImportManager bootstrap() {
		...
		createCustomRealmFromImportJSON();
	...
	private void createCustomRealmFromImportJSON() {
		KeycloakSession session = getSessionFactory().create();
